...
export const presenceweb_add_secondary_host: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
...
export const presenceweb_list_secondary_hosts: (a: number) => any;
...
export const presenceweb_reconnect_secondary_host: (a: number, b: number, c: number, d: number, e: number) => void;
...
export const presenceweb_remove_secondary_host: (a: number, b: number, c: number) => void;
...
export const presenceweb_set_on_secondary_event: (a: number, b: any) => void;
export const presenceweb_set_on_secondary_state: (a: number, b: any) => void;
...
export const wasm_bindgen__closure__destroy__h9201fdb305dc6b9a: (a: number, b: number) => void;
export const wasm_bindgen__convert__closures_____invoke__h920351fd893a14bb: (a: number, b: number, c: any) => void;
export const wasm_bindgen__convert__closures_____invoke__hb9e56f235e147e64: (a: number, b: number) => void;
